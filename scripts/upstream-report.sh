...
#   - docs/upstream-ledger.md (the exception-only intake ledger).
...
banner() {
  ...
  echo " Source of truth: git DAG + docs/upstream-ledger.md"
...
echo " docs/upstream-ledger.md and the git DAG for the authoritative"
